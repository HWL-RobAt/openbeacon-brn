...
const char pxDeviceDescriptor[] = {
  /* Device descriptor */
  /*sizeof(S_usb_device_descriptor)*/ 0x12, // Size of this descriptor, 0x12
  /*USB_DEVICE_DESCRIPTOR*/ 0x01, // DEVICE Descriptor Type, 0x01
 /* USB2_00*/  0x10, 0x01, // USB 2.0 specification, 0x10, 0x01
  /*USB_CLASS_COMMUNICATION*/ 0x02, // USB Communication class code, 0x02
  0x00, // No device subclass code
  0x00, // No device protocol code
  /*USB_ENDPOINT0_MAXPACKETSIZE*/ 0x08, // Maximum packet size for endpoint zero, 0x08
  /*USB_VENDOR_ATMEL*/ 0xC0, 0x16, // ATMEL Vendor ID, 0xC0, 0x16
  /*SER_PRODUCT_ID*/ 0x10, 0x01, // Product ID (6119), 0x10, 0x01
