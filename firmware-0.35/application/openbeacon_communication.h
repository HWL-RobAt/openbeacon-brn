...
typedef struct {
	...
	/* Statistik  */
	unsigned char tx_beacons[4];
	unsigned char fail_tx_beacons[4];
	unsigned char rx_beacons[4];
	unsigned char fail_rx_beacons[4];
} StatusOpenbeacon_V1;
...
*/
#define ETHERNET_TEST_PROTOCOL_FIRST			0x22
#define ETHERNET_TEST_PROTOCOL_SECOND			0x22
